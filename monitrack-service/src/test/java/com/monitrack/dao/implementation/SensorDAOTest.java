...
public class SensorDAOTest {
	...
	private static final SensorConfiguration sensorConfiguration = new SensorConfiguration(0, SensorActivity.ENABLED, SensorType.FLOW, 1, "192.168.20.15", "dsfsd", "dsfsdf", 
