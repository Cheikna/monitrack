...
public class SensorDAOTest {
	...
	private static final Sensor sensor = new Sensor(0, SensorActivity.DISABLED, SensorType.FLOW, 1, "192.168.20.15", "dsfsd", "dsfsdf", 
			1.0f, 2.0f, null, null, null, null, null, 0f, "Decibel", 5.0f, 6.23f, 4.94f);
