...
public class SensorDAOTest {
	...
	public void test1Insert() throws Exception {
		...
		for (int i = 0; i < 9; i++) {
			SensorConfiguration s = (SensorConfiguration) DAOFactory.execute(connection, SensorConfiguration.class, RequestType.INSERT, sensorConfiguration, null, null, null);
